REQUIREMENTS:
openpyxl  -->  to store data in spreadsheet
feedparser  -->  to parse RSS feeds
requests  -->  to load web pages for scrapping
BeautifulSoup4  -->  for scraping HTML pages

NOTE:
Must have a file named db.xlsx in the same folder as master.py
